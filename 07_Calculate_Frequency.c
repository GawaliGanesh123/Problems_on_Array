/* Accept n numbers from the user, then accept another number and find how many times it appears in the array.

Input- 10 15 10 25 10
     Number:10
     
Output- Frequency of 10 is 3 times
